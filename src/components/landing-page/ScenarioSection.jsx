                ...
                <div className="grid items-center grid-cols-1 lg:grid-cols-2 gap-y-12 lg:gap-x-16">
                                ...
                                <div className="p-8">
                                    <div className="space-y-6">
                                        <div className="text-center">
                                            <h3 className="text-lg font-bold text-gray-900">Simulation de Scénarios</h3>
                                        </div>
                                        <div className="space-y-4">
                                            <div className="bg-blue-50 rounded-lg p-4">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-sm font-medium text-blue-900">Scénario Juridique</span>
                                            ...
                                            <div className="bg-green-50 rounded-lg p-4">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-sm font-medium text-green-900">Impact Fiscal</span>
                                            ...
                                            <div className="bg-purple-50 rounded-lg p-4">
                                                <div className="flex items-center justify-between">
                                                    <span className="text-sm font-medium text-purple-900">Contraintes Environnementales</span>
                                        ...
                                        <div className="text-center">
                                            ...
                                            <p className="mt-2 text-sm text-gray-600">Tous les scénarios analysés</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <p className="mt-6 text-lg text-gray-600 font-pj">
                            Visualisez les conséquences de vos choix futurs et prenez des décisions éclairées en toute sérénité en simulant les différents scénarios possibles pour votre projet.
                        </p>
                        <div className="mt-8 space-y-4">
                            <div className="flex items-start">
                                ...
                                <div className="ml-4">
                                    <p className="text-lg text-gray-800"><strong>Analyse juridique complète</strong> de votre situation</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                <div className="flex-shrink-0">
                                ...
                                <div className="ml-4">
                                    <p className="text-lg text-gray-800"><strong>Optimisation fiscale</strong> personnalisée</p>
                                </div>
                            </div>
                            <div className="flex items-start">
                                <div className="flex-shrink-0">
                                ...
                                <div className="ml-4">
                                    <p className="text-lg text-gray-800"><strong>Respect des normes environnementales</strong></p>
                                </div>
                            </div>
                        </div>
                        <div className="mt-10">
                            <button className="inline-flex items-center px-6 py-3 text-base font-semibold text-white transition-all duration-200 bg-purple-600 rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-600">
                                Simuler un scénario
                            </button>
                        </div>
                    </div>
