      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="px-6 text-lg text-gray-700 font-inter">
            Imaginez-vous avoir à votre disposition un assistant juridique
            permanent, disponible 24/7, qui répond en quelques secondes à toutes
            vos questions en droit immobilier !
          </h1>
